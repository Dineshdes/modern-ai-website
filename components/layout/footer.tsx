...
const XIcon = () => (
  <svg width="14" height="14" viewBox="0 0 13 12" fill="currentColor">
...
const COLS = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "ISO 27701", href: "#", badge: "Certified" },
      { label: "SOC 2", href: "#", badge: "Certified" },
      { label: "HIPAA", href: "#", badge: "Compliant" },
      ...
      <div className="max-w-[1400px] mx-auto px-8 pt-14 pb-10">
        ...
        <div className="flex items-center justify-between mb-14">
          <div className="flex items-center gap-3">
            <a href="/" className="flex items-center gap-2.5">
              <div
                ...
                style={{ width: 28, height: 28, background: "#34D59A", flexShrink: 0 }}
              >
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                  <path d="M2.5 2h9v6.5L7 12V7.5H2.5V2z" fill="#000" />
                </svg>
              </div>
              <span style={{ fontSize: 17, fontWeight: 600, color: "#FFFFFF" }}>Synapse</span>
            </a>
            <span style={{ fontSize: 14, color: "#777B7F", marginLeft: 6 }}>An AI Inference Company</span>
          </div>
          ...
          >
            ...
            <span style={{ fontSize: 14, color: "#777B7F" }}>All systems operational</span>
          </a>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-14">
          {COLS.map((col) => (
            <div key={col.heading}>
              <h3
                className="uppercase tracking-[0.14em] font-medium mb-5"
                style={{ fontSize: 11, color: "#777B7F", letterSpacing: "0.14em" }}
              >
                {col.heading}
              </h3>
                  ...
                  <li key={link.label}>
                    ...
                    >
                      ...
                      {"badge" in link && link.badge && (
                        <span style={{ fontSize: 11, color: "#777B7F", marginLeft: 2 }}>
                          {link.badge}
                        </span>
                      )}
                      {"hasChevron" in link && link.hasChevron && (
                        <svg width="8" height="8" viewBox="0 0 8 8" fill="none" style={{ opacity: 0.35, marginLeft: 1 }}>
        ...
        >
          <div className="flex items-center gap-3" style={{ fontSize: 14, color: "#777B7F" }}>
            <span>Made in SF and the World.</span>
            <span style={{ opacity: 0.3 }}>&middot;</span>
            <span>Copyright &copy; 2024&ndash;2026 Synapse AI, Inc.</span>
          </div>
          <div className="flex items-center gap-5" style={{ fontSize: 14, color: "#777B7F" }}>
            {["Privacy", "Terms", "Cookie Settings"].map((item, i, arr) => (
              <span key={item} className="flex items-center gap-5">
                <a
                  ...
                  onMouseLeave={(e) => (e.currentTarget.style.color = "#777B7F")}
                >
                  {item}
                </a>
                {i < arr.length - 1 && <span style={{ opacity: 0.25 }}>&middot;</span>}
              </span>
            ))}
          </div>
        </div>
